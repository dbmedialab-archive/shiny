...
export default withInfo({
	text: `
<Paragraph>LinkBarSearchField is a search field for link bars.</Paragraph>

<Paragraph>LinkBar elements match each other in height and horizontal spacing. Therefore,
