...
const Bar = styled.ul`
  ...
  width: ${props => (props.shouldAdjustForNestedPadding ? `calc(100% + 2*${props.theme.variables.horizontalBase})` : '100%')};
...
const NavWithOptionalConstrainer = ({ width, background, zIndex, isTopLevelComponent, ...props }) => {
